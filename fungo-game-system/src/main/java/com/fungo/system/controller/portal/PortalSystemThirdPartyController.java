...
/**
 * pc端 第三方登录验证处理接口
 * currentVersion: PC2.0
 * @author sam
 *
 */
@RestController
@Api(value = "", description = "第三方登录验证处理接口")
public class PortalSystemThirdPartyController {
    ...
    @ApiImplicitParams({})
    @RequestMapping(value = "/api/portal/system/user/login/thirdparty", method = RequestMethod.POST)
    ...
    @ApiImplicitParams({})
    @RequestMapping(value = "/api/portal/system/mine/thirdparty", method = RequestMethod.POST)
    ...
    @ApiImplicitParams({})
    @RequestMapping(value = "/api/portal/system/mine/thirdparty", method = RequestMethod.DELETE)
    ...
    @ApiImplicitParams({})
    @RequestMapping(value = "/api/portal/system/user/mobile/thirdparty", method = RequestMethod.POST)
    ...
    @ApiImplicitParams({})
    @RequestMapping(value = "/api/portal/system/mine/thirdparty", method = RequestMethod.GET)

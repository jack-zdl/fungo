...
//            //用户登录逻辑校验
//            respJson = RespJsonFactory.buildSuccess(); //sysUserLoginServiceImpl.userLogin(sysUserDto);
...
//            RespJson pageview = RespJsonFactory.buildSuccess(); //sysUserServiceImpl.queryPage(sysUserDto);
//            //非空校验
...
//            }
//            //获取用户登录详细信息
//            SysUserLoginDto loginUser = new SysUserLoginDto(); //sysUserLoginServiceImpl.selectByPrimaryKey(user.getUserId(), user.getTenantId());

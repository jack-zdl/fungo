...
public class PortalSystemDeveloperController {
	...
	@RequestMapping(value="/api/portal/system/developer/addUser", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/gameList", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/messageList", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/gameDetail/{gameId}", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/addGame", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/gemeAnalyze", method= RequestMethod.POST)
	@ApiImplicitParams({})
	...
	@RequestMapping(value="/api/portal/system/developer/communityAnalyze", method= RequestMethod.POST)
	@ApiImplicitParams({})
...
//		}
	...
	@RequestMapping(value="/api/portal/system/developer/updateGame", method= RequestMethod.POST)
	@ApiImplicitParams({})

...
public class MemberSNSServiceImpl implements IMemberSNSService {
     ...
     * @throws Exception
     */
    private void excAddTaskExpAndFungoCoin(String memberId, Integer snsType)  {
        AbstractEventDto abstractEventDto = new AbstractEventDto(this);
        //V2.4.6起版本的任务
        switch (snsType) {
            //微博
            case 0:
                abstractEventDto.setEventType( AbstractEventDto.AbstractEventEnum.BINDWEIBO_USER.getKey());
...
//                        MemberIncentTaskConsts.INECT_TASK_VIRTUAL_COIN_TASK_CODE_IDT, FunGoIncentTaskV246Enum.TASK_GROUP_NEWBIE_SNS_WB_COIN.code());
            ...
            //微信
            case 1:
                abstractEventDto.setEventType( AbstractEventDto.AbstractEventEnum.BINDWECHAT_USER.getKey());
                abstractEventDto.setUserId(memberId);
                applicationEventPublisher.publishEvent(abstractEventDto);
//                //1 经验值
//                iMemberIncentDoTaskFacadeService.exTask(mb_id, FunGoIncentTaskV246Enum.TASK_GROUP_NEWBIE.code(),
...
//                        MemberIncentTaskConsts.INECT_TASK_VIRTUAL_COIN_TASK_CODE_IDT, FunGoIncentTaskV246Enum.TASK_GROUP_NEWBIE_SNS_WX_COIN.code());
            ...
            case 4:
                //1 经验值
                abstractEventDto.setEventType( AbstractEventDto.AbstractEventEnum.BINDQQ_USER.getKey());
                abstractEventDto.setUserId(memberId);
                applicationEventPublisher.publishEvent(abstractEventDto);
//                iMemberIncentDoTaskFacadeService.exTask(mb_id, FunGoIncentTaskV246Enum.TASK_GROUP_NEWBIE.code(),

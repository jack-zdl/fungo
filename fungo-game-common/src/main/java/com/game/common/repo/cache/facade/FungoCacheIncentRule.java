 ...
 * @Description:fungo 用户激励体系之等级、身份、荣誉规则模块缓存
 *   缓存key规则：
 *       1.与用户无关
 *             接口_入参
 *       2.与用户有关
 ...
 */
@Component
public class FungoCacheIncentRule {

    private final Logger logger = LoggerFactory.getLogger(FungoCacheIncentRule.class);
...
//    public static final Integer REDIS_EXPIRE_DEFAULT = 60 * 10;
     ...
     * 缓存时间：30天
     */
    public static final Integer REDIS_EXPIRE_30_DAYS = 60 * 60 * 24 * 30;

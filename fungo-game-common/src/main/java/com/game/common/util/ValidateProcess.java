...
class ValidateProcess {
    ...
    static void notNull(Object value) {
        if (null == value) throw new ParamsException(NotNullErrorMsg);
    }

    static void notNull(String value) {
        if (CommonUtil.isNull(value)) throw new ParamsException(NotNullErrorMsg);
    }

    static void notNull(Number number) {
        if (null == number) throw new ParamsException(NotNullErrorMsg);
    }
    ...
    static void max(int max, int value) {
        if (value > max) throw new ParamsException(MaxErrorMsg + ", max:" + max + ", value:" + value);
    }
    ...
    static void min(int min, int value) {
        if (value < min) throw new ParamsException(MinErrorMsg + ", min:" + min + ", value:" + value);
    }
    ...
    static void minLength(int min, String value) {
        if (!CommonUtil.isNull(value)) {
            if (value.length() < min) throw new ParamsException(MinErrorMsg + ", min:" + min + ", value:" + value);
        }
    }
    ...
    static void idCard(String value) {
        if (!CommonUtil.isNull(value)) {
            ...
            if (length != 15 && length != 18) {
                throw new ParamsException(IdCardErrorMsg + ", value:" + value);
            }
            //校验区域
    ...
    static void chinese(String value) {
        ...
        if (!ret) {
            throw new ParamsException(ChineseErrorMsg + ", value:" + value);
        }
    }

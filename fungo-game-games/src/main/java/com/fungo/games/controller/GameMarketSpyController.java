...
public class GameMarketSpyController {
    ...
    public ResultDto<HashMap<String, Object>> queryGameFungoappRef(@Anonymous MemberUserProfile memberprofile,
                                                                   @RequestBody GameFungoAppRefInput gameFungoAppRefInput) throws Exception {
